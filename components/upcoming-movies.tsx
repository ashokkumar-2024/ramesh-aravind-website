        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 max-w-[1400px] mx-auto">
          {movies.map((movie) => (
            <div key={movie.title} className="group relative">
              <div className="aspect-[2/3] overflow-hidden rounded-2xl transition-all duration-500 group-hover:-translate-y-2 flex justify-center items-center bg-gray-900">
                <img
                  src={movie.image}
                  alt={movie.title}
